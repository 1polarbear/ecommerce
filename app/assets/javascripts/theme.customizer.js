...
function whiterabbit_theme_customizer(option, val) {
	...
	if (option == 'body_style') {
		...
		whiterabbit_custom_options_show_loader();
		//location.reload();
		var loc = jQuery('#co_site_url').val();
		var params = WHITERABBIT_STORAGE['co_add_params']!=undefined ? WHITERABBIT_STORAGE['co_add_params'] : {};
		params[option] = val;
